                    ...
                    <?php foreach ($users as $index => $user) : ?>
                        <tr>
                            ...
                            <td style="vertical-align: middle;">
                                <button class="btn btn-modalDetail btn-outline-black text-black hover-text-white" data-username="<?= $user['username'] ?>" data-photo="<?= $user['photo'] ?>" data-name="<?= $user['name'] ?>" data-target-modal="editModal">
                                    Edit
                                </button>
                            </td>
                        </tr>
            ...
            <form action="/?users-edit" method="post" autocomplete="off" enctype="multipart/form-data">
                <div class="d-flex">
                    <div class="me-2">
                        ...
                        <div class="mb-2">
                            <p>Photo Profile</p>
                            <input data-target-preview="previewImgCreate" class="form-controll" type="file" name="photo">
                        </div>
                    </div>
                    <div>
                        <p>Preview</p>
            ...
            <form action="/?users-create" method="post" autocomplete="off" enctype="multipart/form-data">
                <div class="d-flex">
                    <div class="me-2">
                        ...
                        <div class="mb-2">
                            <p>Photo Profile</p>
                            <input id="photoInput" data-target-preview="previewImgCreate" class="form-controll" type="file" name="photo">
                        </div>
                    </div>
                    <div>
                        <p>Preview</p>
